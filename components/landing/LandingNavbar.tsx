    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between h-16">
                ...
                <div
                    className="w-8 h-8 bg-indigo-600 rounded-lg flex items-center
                ...
                {loading ? (
                    ...
                    /* ── logged in: show avatar + go to dashboard + logout ── */
                    <div className="flex items-center gap-2">
                    {/* Avatar + name */}
                    <div className="flex items-center gap-2 px-3 py-1.5 glass
                                    rounded-xl border border-[#2a2a3a]">
                        <div
                        className="w-6 h-6 bg-indigo-600/40 border border-indigo-500/40
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl
                                text-sm font-medium text-[#8b8ba7]
            ...
            {mobileOpen && (
            <div
                className="md:hidden glass border-t border-[#2a2a3a]/60
                            animate-slide-up"
            >
                ...
                <div className="pt-2 border-t border-[#2a2a3a]/60 space-y-2">
                    ...
                    <>
                        ...
                        <div
                            className="w-7 h-7 bg-indigo-600/40 border border-indigo-500/40
                                        rounded-full flex items-center justify-center
                                        text-xs font-bold text-indigo-300"
                        >
                            {user.username[0].toUpperCase()}
                        </div>
                        <span className="text-sm text-[#c4c4d4]">{user.username}</span>
                        </div>
