...
const howItWorks = [
    {
        ...
        desc: 'Sign up securely with your email and password. Your personal workspace is ready instantly.',
    },
    {
        step: '02',
                ...
                <section className="relative min-h-screen flex flex-col items-center
                    ...
                    <div className="absolute inset-0 pointer-events-none overflow-hidden">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2
                                        ...
                                        bg-pink-600/5 rounded-full blur-3xl" />
                        {/* Grid */}
                        <div
                    ...
                    <div className="relative max-w-5xl mx-auto text-center">
                        ...
                        <div className="relative flex flex-col md:flex-row items-center
                            ...
                            <div className="w-12 h-12 glass rounded-2xl flex items-center
                                            ...
                                            glow-indigo shrink-0 hidden md:flex
                                            animate-pulse-glow">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {stats.map(({ value, label }) => (
                                <div key={label} className="text-center">
                                    ...
                                    <div className="text-sm text-[#8b8ba7] font-medium">
                                        {label}
                                    </div>
                                </div>
                            ))}
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
                            ...
                            <div className="hidden md:block absolute top-8 left-[16.7%]
                                            ...
                                            from-indigo-500/0 via-indigo-500/40
                                            to-indigo-500/0" />

                            {howItWorks.map(({ step, title, desc }) => (
                                <div key={step} className="relative text-center group">
                                    <div className="w-16 h-16 glass rounded-2xl flex items-center
